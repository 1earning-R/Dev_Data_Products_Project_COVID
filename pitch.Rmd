...
report_dir <- "data/covid_data/county_reports/"
...
## Create a key to combine pop data with covid data
...
write.csv(county_data, "data/covid_data/data_sets/county_data2.csv")
write.csv(state_data, "data/covid_data/data_sets/state_data2.csv")
```
## BACKGROUND
